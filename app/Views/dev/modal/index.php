			...
			<div class="flex-column current" data-kt-stepper-element="content">
				<div class="scroll-y h-500px mb-10" id="devConsole"
					...
					<ul id="console">
						...
						<li>phpinfo::development <a
								href='<?= base_url('dev/phpInfo') ?>'
								target='_blank'><i class="bi bi-link-45deg"></i> dev.paypara.co/dev/phpInfo</a></li>
						<li>phpinfo::production <a href='https://app.paypara.co/dev/phpInfo' target='_blank'><i
									class="bi bi-link-45deg"></i> app.paypara.co/dev/phpInfo</a></li>
						<li>api.postman::development <a
								href='https://dev.paypara.co/deploy/documents/dev/postman/api.dev.paypara.co.postman.json'
								target='_blank'><i class="bi bi-paperclip"></i> api.dev.paypara.co.postman.json</a></li>
						<li>api.postman::production <a
								href='https://dev.paypara.co/deploy/documents/dev/postman/api.paypara.co.postman.json'
								target='_blank'><i class="bi bi-paperclip"></i> api.paypara.co.postman.json</a></li>
					</ul>
				</div>
			</div>
		</div>
