<div class="my-auto">
  <form id="bank-form" method="post" autocomplete="off">
    ...
    <div class="mb-3">
      <div class="position-relative">
        ...
        <div class="row">
          <a id="next" class="d-inline-block text-gray-800 text-hover-primary fw-bold text-center text-wrap w-100">&lt; Papara hesabı almak istiyorum &gt;</a>
        </div>
      </div>
    </div>
  </form>
