          ...
          <div id="kt_header" class="header">
            <div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
              <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">User Authorization</h1>
                <ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
                  <li class="breadcrumb-item text-muted">
                    <a href="dashboard" class="text-muted">Dashboard</a>
                  </li>
                  <li class="breadcrumb-item text-muted">
                    <a href="/user/index" class="text-muted">Users</a>
                  </li>
                ...
                <div class="card-header">
                  <div class="card-title justify-content-between w-100 m-0">
                    ...
                    <button type="button" class="btn btn-sm btn-light-primary" id="formAjax" data-bs-toggle="modal" data-bs-target="#ajaxModal" data-url="user/role/0">
                      <i class="bi bi-plus-circle fs-5"></i>Add New Role
                    </button>
                    <? endif; ?>
                  </div>
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="datatableRole">
                      <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                          <th class="min-w-200px">Role Name</td>
                          <th class="min-w-200px">Assigned Users</td>
                          <th class="min-w-150px text-end">Actions</td>
                        </tr>
                      </thead>
                      <tbody></tbody>
                    </table>
