                ...
                <div class="card-header border-0 pt-6">
                  <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                      ...
                      <input type="text" data-kt-customer-table-filter="search" id="search" id="searchStr" class="form-control form-control-solid border border-1 w-250px ps-15" placeholder="Müşteri ara" />
                    </div>
                  </div>
                        ...
                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                          <div class="row mb-3">
                            <div class="col-3 d-flex align-items-center">
                              <label class="form-label fs-6 fw-semibold text-end w-100 m-0">Firma:</label>
                            </div>
                            <div class="col ps-0">
                              <select class="form-select form-select-solid border border-1 fw-bold" id="selectClient" data-kt-select2="true" data-placeholder="Tümü" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                <option></option>
                              </select>
                            </div>
                          </div>
                          <div class="row mb-3">
                            ...
                            <div class="col ps-0">
                              <select class="form-select form-select-solid border border-1 fw-bold" id="isVip" data-kt-select2="true" data-placeholder="Tümü" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                <option></option>
