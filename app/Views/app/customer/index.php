                ...
                <div class="card-header border-0 pt-6">
                  <div class="card-title w-100 w-sm-auto">
                    <div class="d-flex align-items-center w-100 w-sm-auto my-1">
                      ...
                      <input type="text" data-kt-customer-table-filter="search" id="search" class="form-control form-control-solid border border-1 w-100 w-sm-250px ps-15" placeholder="Search customer" />
                    </div>
                  </div>
