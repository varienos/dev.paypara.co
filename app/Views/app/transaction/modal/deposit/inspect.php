        <!--begin::Modal - New Inspect-->
      <div data-kt-drawer="true" data-kt-drawer-activate="true" data-kt-drawer-toggle="#inspect-btn" data-kt-drawer-close="#close-inspect" data-kt-drawer-width="360px" style="border-top-left-radius: .75rem;">
        <div id="inspect-info" class="card w-100 rounded-0">
          <div class="card-header d-flex flex-nowrap bg-transparent border-0 min-h-55px p-0">
            <div class="card-title w-100 m-0">
              <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x align-items-end fs-6 w-100 h-100 ps-5">
                <li class="nav-item">
          ...
          <div class="card-body hover-scroll-overlay-y p-0">
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active p-5" id="tab_details" role="tabpanel">
                  ...
                  <p class="fs-6 text-center text-gray-700 m-0">22.10.2022 19:38:51</p>
                    ...
                    <div class="card-body px-0 pb-0 pt-8">
                      <div class="d-flex flex-column rounded-2 w-100 p-0 mt-5">
                        ...
                        <div class="d-flex flex-column flex-center">
                          ...
                          <p class="fs-3 fw-bold m-0 mt-1 mb-6">₺7500,00</p>
                          <span class="badge badge-light-success fs-7 mb-6">Onaylandı</span>
                        </div>
                        <div class="card-footer d-flex pe-0 ps-5 py-5">
                          <p class="fs-5 fw-semibold text-gray-700 p-0 m-0 me-2">Hesap:</p>
                          <a href="javascript:;" onclick="alert('Redirects to account detail page as target=\'_blank\'');" class="d-flex align-items-center text-reset text-hover-primary p-0">
                            <p class="fs-6 fw-semibold text-gray-900 m-0 me-1">Ramazan Oruç <small>(2157)</small></p>
                    ...
                    <table class="table fs-6 fw-semibold gs-0 gy-2 gx-2 m-0">
                      <tbody>
                        <tr class="">
                          ...
                          <td class="text-gray-800 p-0 pb-3">{01:42}</td>
                        </tr>
                        <tr class="">
                          <td class="text-gray-600 p-0 pb-3 w-125px">TXID:</td>
                          <td class="text-gray-800 p-0 pb-3">{5915485}</td>
                        </tr>
                        <tr class="">
                          <td class="text-gray-600 p-0 pb-3">User ID:</td>
                          <td class="text-gray-800 p-0 pb-3">{7542169}</td>
                        </tr>
                        <tr class="">
                          <td class="text-gray-600 p-0 pb-3">Firma:</td>
                          <td class="text-gray-800 p-0 pb-3">{Demobet}</td>
                        </tr>
                        <tr class="">
                          <td class="text-gray-600 p-0 pb-3">Yöntem:</td>
                          <td class="p-0 pb-3">
                            <span class="badge bg-danger text-white">Eşleşme</span>
                          </td>
                        </tr>
                        <tr class="">
                          <td class="text-gray-600 p-0 pb-3">Personel:</td>
                          <td class="text-gray-800 p-0 pb-3">{Atahan}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <div class="row ps-3">
                    ...
                    <textarea class="form-control form-control-solid border p-2" style="resize: none; overflow: scroll;" spellcheck="false" disabled>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras dignissim.</textarea>
                  </div>
              </div>
