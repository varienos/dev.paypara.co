<form class="form" action="javascript:" id="modalForm" method="post" enctype="multipart/form-data">
  ...
  <div class="modal-body pt-5 pb-2 ps-5">
    <div class="row d-flex fs-5">
      ...
      <div class="col-4 text-end mb-3">
        <label class="fw-bold">Yöntem:</label>
      </div>
      <div class="col-8">
        <div class="badge badge-light-danger fs-7"><?=ucfirst($update->accountType) ?></div>
      </div>
      <div class="col-4 text-end mb-3">
      ...
      <div class="col-4 text-end mb-3">
        <label class="fw-bold">Hesap:</label>
      </div>
      <div class="col-8">
        <label class="text-gray-800"><?=$update->account_name ?> (#<?=$update->papara_account_id ?>)</label>
      </div>
      <div class="col-4 text-end mb-3">
    ...
    <div class="row">
      <div class="col-12 text-center">
        <div class="fw-bold fs-3 rotate collapsible text-center mt-5 mb-7" data-bs-toggle="no-collapse" href="#kt_modal_add_to_reserves" role="button" aria-expanded="true" aria-controls="#kt_modal_add_to_reserves" onclick="this.childNodes[1].classList.add('rotate-180');" style="opacity: .5; cursor: not-allowed;">Rezervlere Ekle
          <span class="ms-2">
