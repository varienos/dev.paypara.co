<div class="modal fade" id="new-reject" tabindex="-1" aria-hidden="true" style="--bs-modal-border-radius: 0 !important;">
      ...
      <form class="form" action="#" id="kt_modal_add_customer_form">
        <div class="modal-header d-flex align-items-start border-bottom-0 p-7" id="kt_modal_add_customer_header">
          <div class="d-flex flex-column">
            <h2 class="fs-4 fw-bold mb-2">Talep #5915485</h2>
            <h2 class="fs-7 fw-semibold text-gray-600">Bugün, 16:42:27</h2>
          </div>
          <button type="button" class="btn btn-icon btn-sm btn-active-icon-primary align-items-start" data-bs-dismiss="modal">
            <span class="svg-icon svg-icon-2qx svg-icon-dark">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity="1" d="M6 19.7C5.7 19.7 5.5 19.6 5.3 19.4C4.9 19 4.9 18.4 5.3 18L18 5.3C18.4 4.9 19 4.9 19.4 5.3C19.8 5.7 19.8 6.29999 19.4 6.69999L6.7 19.4C6.5 19.6 6.3 19.7 6 19.7Z" fill="currentColor"/><path d="M18.8 19.7C18.5 19.7 18.3 19.6 18.1 19.4L5.40001 6.69999C5.00001 6.29999 5.00001 5.7 5.40001 5.3C5.80001 4.9 6.40001 4.9 6.80001 5.3L19.5 18C19.9 18.4 19.9 19 19.5 19.4C19.3 19.6 19 19.7 18.8 19.7Z" fill="currentColor"/>
              </svg>
            </span>
          </button>
        </div>
        <div class="modal-body py-0 px-7">
          <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
            <div id="reject-info" class="d-flex flex-column flex-center h-95px mb-5">
              <div class="fs-3 fw-bolder mb-1">Mustafa Veli Topel</div>
              <div class="fs-4 fw-bold">₺4.200,00</div>
            </div>
              ...
              <div class="d-flex mb-3">
                ...
                <div class="d-flex flex-column">
                  ...
                  <div class="input-group input-group-solid input-group-sm w-100">
                    ...
                    <input type="text" class="form-control border-0 bg-transparent fs-6 text-gray-600 h-25px p-0" maxlength="9" value="4.200,00">
                  </div>
                </div>
              </div>
              <div class="d-flex">
                ...
                <div class="d-flex flex-column w-100">
                  ...
                  <div class="d-flex align-items-center input-group input-group-solid input-group-sm">
                    ...
                    <input type="text" class="form-control bg-transparent fs-6 text-gray-600 border-0 h-25px p-0" placeholder="Açıklama ekle">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="modal-footer border-top-0 d-flex flex-nowrap flex-center px-7 pb-7 pt-6">
          ...
          <button type="button" id="approve" class="btn btn-sm btn-dark rounded-0 fs-6 fw-bold w-100 h-40px mh-40px p-0 m-0">Reddet</button>
        </div>
      </form>
    </div>
  </div>
