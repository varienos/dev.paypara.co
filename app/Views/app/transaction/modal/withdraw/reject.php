<form class="form" action="javascript:" id="modalForm" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" value="withdraw" name="request"></input>
  <div class="modal-header py-3 px-5" id="kt_modal_add_customer_header">
    <h2 class="fs-4 fw-bold">İşlemi Reddet</h2>
  ...
  <div class="modal-body py-5 px-lg-10">
    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
      <div class="d-flex flex-column mb-5">
        ...
        <label class="fs-5 fw-semibold mb-2 text-center">Çekimini <span class="fw-bolder border-bottom border-danger border-4 text-dark px-1">reddetmek</span> istediğinize emin misiniz?</label>
      </div>
  ...
  <div class="modal-footer flex-center py-3">
    ...
    <button type="submit" id="kt_modal_add_customer_submit" class="btn btn-sm btn-danger w-90px">Reddet</button>
  </div>
</form>