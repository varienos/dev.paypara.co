                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body py-10 px-lg-17">
                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_create_new_firm_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_create_new_firm_header" data-kt-scroll-wrappers="#kt_modal_create_new_firm_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div id="firm-limits" class="collapse">
                                            <div class="d-flex flex-column mb-5">
                                                <label class="required fs-5 fw-semibold">Deposit Limits</label><label class="fw-semibold text-gray-600 lh-sm mb-2">Deposit limit range for transactions</label>
                                                <div class="row gx-3">
                                                    <div class="col">
                                            ...
                                            <div class="d-flex flex-column mb-5">
                                               <label class="required fs-5 fw-semibold">Withdrawal Limits</label><label class="fw-semibold text-gray-600 lh-sm mb-2">Withdrawal limit range for transactions</label>
                                                <div class="row gx-3">
                                                    <div class="col">
