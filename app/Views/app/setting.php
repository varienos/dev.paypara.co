...
<body id="kt_body" class="sidebar-disabled"></body> <?php require appViewPath().'partials/theme-mode/_init.php' ?> <?php foreach ($setting as $row) { $param["$row->name"] = $row->value; }?> <div class="d-flex flex-column flex-root">
                                ...
                                <div class="modal-body py-10 px-lg-17">
                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_create_new_firm_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_create_new_firm_header" data-kt-scroll-wrappers="#kt_modal_create_new_firm_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div class="d-flex flex-column mb-5 fv-row">
                                            ...
                                            <div class="d-flex flex-column mb-5 fv-row">
                                                <label class="required fs-5 fw-semibold">Min. Deposit Limit</label><label class="fw-semibold text-gray-600 lh-sm mb-2">Minimum amount of deposit for transactions</label>
                                                <div class="d-flex flex-row">
                                                    <div class="input-group"><span class="input-group-text border">₺</span><input type="text" <?=edit_firm!==true?"disabled":null; ?> class="form-control form-control-solid border" name="limitDepositMin" data-default="250" value="250"></div>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-column mb-5 fv-row">
                                                <label class="required fs-5 fw-semibold">Max. Deposit Limit</label><label class="fw-semibold text-gray-600 lh-sm mb-2">aximum amount of deposit for transactions</label>
                                                <div class="d-flex flex-row">
                                                    <div class="input-group"><span class="input-group-text border">₺</span><input type="text" <?=edit_firm!==true?"disabled":null; ?> class="form-control form-control-solid border" name="limitDepositMax" data-default="15000" value="15000"></div>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-column mb-5 fv-row">
                                               <label class="required fs-5 fw-semibold">Min. Withdrawal Limit</label><label class="fw-semibold text-gray-600 lh-sm mb-2">>Minimum amount of withdrawal for transactions</label>
                                                <div class="d-flex flex-row">
                                                    <div class="input-group"><span class="input-group-text border">₺</span><input type="text" <?=edit_firm!==true?"disabled":null; ?> class="form-control form-control-solid border" name="limitWithdrawMin" data-default="250" value="250"></div>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-column mb-5 fv-row">
                                               <label class="required fs-5 fw-semibold">Max. Withdrawal Limit</label><label class="fw-semibold text-gray-600 lh-sm mb-2">Maximum amount of withdrawal for transactions</label>
                                               <div class="d-flex flex-row">
                                                    <div class="input-group"><span class="input-group-text border">₺</span><input type="text" <?=edit_firm!==true?"disabled":null; ?> class="form-control form-control-solid border" name="limitWithdrawMax" data-default="15000" value="15000"></div>
                                                </div>
                                            </div>
