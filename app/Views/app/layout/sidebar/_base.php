			...
			<div class="hover-scroll-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-offset="0px" data-kt-scroll-dependencies="#kt_sidebar_tabs" data-kt-scroll-wrappers="#kt_sidebar_content, #kt_sidebar_body">
				...
				<div class="tab-content px-5 px-xxl-10">
						...
						<div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
							...
							<div class="card-header align-items-center border-0">
								...
								<div class="card-toolbar">
									...
									<!--begin::Menu 1-->
									<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_631dd1e3c7f99">
										<!--begin::Header-->
										<div class="px-7 py-5">
										...
										<div class="px-7 py-5">
											...
											<div class="mb-10">
												...
												<!--begin::Input-->
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_631dd1e3c7f99" data-allow-clear="true">
														<option></option>
					...
					<div class="tab-pane fade" id="kt_sidebar_tab_2" role="tabpanel">
						...
						<!--end::Statistics Widget-->
						<?php include 'layout/sidebar/widgets/_orders.php' ?>
					</div>
					<!--end::Tab pane-->
					<!--begin::Tab pane-->
					<div class="tab-pane fade show active" id="kt_sidebar_tab_3" role="tabpanel">
						...
						<!--end::Statistics Widget-->
						<?php include 'layout/sidebar/widgets/_best-sellers.php' ?>
					</div>
					<!--end::Tab pane-->
					<!--begin::Tab pane-->
						...
						<div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
							...
							<div class="card-header align-items-center border-0">
								...
								<div class="card-toolbar">
									...
									<!--begin::Menu 1-->
									<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_631dd1e3c81dc">
										<!--begin::Header-->
										<div class="px-7 py-5">
											<div class="fs-5 text-dark fw-bold">Filter Options</div>
										</div>
										...
										<div class="px-7 py-5">
											...
											<div class="mb-10">
												...
												<!--begin::Input-->
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_631dd1e3c81dc" data-allow-clear="true">
														<option></option>
														<option value="1">Approved</option>
														<option value="2">Pending</option>
														<option value="2">In Process</option>
					...
					<div class="tab-pane fade" id="kt_sidebar_tab_5" role="tabpanel">
						<?php include 'layout/sidebar/widgets/_stats.php' ?>
						<?php include 'layout/sidebar/widgets/_tasks.php' ?>
					</div>
					<!--end::Tab pane-->
				</div>
				<!--end::Tab content-->
