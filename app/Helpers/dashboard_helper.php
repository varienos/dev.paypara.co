...
{
    $db   = \Config\Database::connect();
    $data = $db->query("SELECT SUM(price) as depositMonthly
    FROM finance
    WHERE
    request='deposit' AND
...
{
    $db     = \Config\Database::connect();
    $data = $db->query("SELECT COUNT(id) as depositProcessMonthly
    FROM finance
    WHERE
    request='deposit' AND
    MONTH(request_time) = MONTH(CURRENT_DATE()) AND
...
{
    $db     = \Config\Database::connect();
    $data = $db->query("SELECT COUNT(id) as bankProcessMonthly
    FROM finance
    WHERE
    request='deposit' AND
    account_type=3 AND
...
{
    $db     = \Config\Database::connect();
    $data = $db->query("SELECT COUNT(id) as posProcessMonthly
    FROM finance
    WHERE
    request='deposit' AND
    account_type=4 AND
...
{
    $db     = \Config\Database::connect();
    $data = $db->query("SELECT COUNT(id) as matchProcessMonthly
    FROM finance
    WHERE
    request='deposit' AND
    account_type=2 AND
...
{
    $db   = \Config\Database::connect();
    $data = $db->query("SELECT SUM(price) as withdrawMonthly
    FROM finance
    WHERE
    request='withdraw' AND
    MONTH(request_time) = MONTH(CURRENT_DATE()) AND
...
{
    $db     = \Config\Database::connect();
    $data = $db->query("SELECT COUNT(id) as withdrawProcessMonthly
    FROM finance
    WHERE
    request='withdraw' and
    MONTH(request_time) = MONTH(CURRENT_DATE()) AND
...
{
    $db   = \Config\Database::connect();
    $data = $db->query("SELECT COUNT(id) as getCustomerTotalProcessWithAccount
    FROM finance
    WHERE
    request='deposit' and
    `status`='onaylandı' and
    gamer_site_id='" . $gamer_site_id . "' and
    account_id='" . $account_id . "'")->getRow();
...
{
    $db   = \Config\Database::connect();
    $data = $db->query("SELECT SUM(price) as getCustomerTotalDepositWithAccount
    FROM finance
    WHERE
    request='deposit' and
    `status`='onaylandı' and
