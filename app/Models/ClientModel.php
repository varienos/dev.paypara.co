...
class ClientModel extends Model
{
	...
	{
		$this->db->query("update site set isDelete='1', status='0' where id='" . $id . "'");
	...
	{
		return $this->db->query("select * from site where isDelete=0 and status='on' order by site_name asc")->getResult();
		$this->error->dbException($this->db->error()) != true ? die() : null;
	}
