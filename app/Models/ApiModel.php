...
class ApiModel extends Model
{
	...
	public function getAccountPrepare($key, $price, $userId, $transaction_id, $method)
	{
        ...
        if($method=="bank")
        {
            if(bankStatus!="on")
            {
                return $this->error->string("bank_method_disable",__CLASS__,__FUNCTION__);
            }
            if($this->paypara->setNumber($price)<$this->paypara->setNumber(bankMinDeposit))
            {

                return $this->error->string("min_deposit_bank_error",__CLASS__,__FUNCTION__);
            }
            if($this->paypara->setNumber($price)>$this->paypara->setNumber(bankMaxDeposit))
            {
                return $this->error->string("max_deposit_bank_error",__CLASS__,__FUNCTION__);
            }
        }
    ...
    public function approve($apiKey,$requestId)
	{
		...
		if($dataCheck->id==""){ $this->log($this->getSiteId($apiKey), $this->error->string("request_id_not_found",__CLASS__,__FUNCTION__),__FUNCTION__); return  $this->error->string("request_id_not_found",__CLASS__,__FUNCTION__); }
	...
	public function deposit($method="papara",$status="beklemede")
	{
        ...
        if($gamerData->deposit!="on")
        {
            ...
            $this->log($this->getSiteId($key),$this->error->string("user_deposit_disable",__CLASS__,__FUNCTION__),__FUNCTION__);
            return $this->error->string("user_deposit_disable",__CLASS__,__FUNCTION__);
        }
	...
	public function withdraw()
	{
        ...
        if($gamerData->withdraw!="on")
        {
            ...
            $this->log($this->getSiteId($key),$this->error->string("user_withdraw_disable",__CLASS__,__FUNCTION__),__FUNCTION__);
            return $this->error->string("user_withdraw_disable",__CLASS__,__FUNCTION__);
        }
		$this->db->query("insert into finance set
        `gamer_site_id` 		= '".$userId."',
		`user_name` 			= '".$userName."',
